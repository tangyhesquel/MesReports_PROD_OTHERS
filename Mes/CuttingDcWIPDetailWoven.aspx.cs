...
public partial class Mes_CuttingDcWIPDetailWoven : pPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        hfValue.Value = Factory_CD;
        if (Factory_CD == "PTX" || Factory_CD == "EGM" || Factory_CD == "TIL" || Factory_CD == "EGV" || Factory_CD == "EAV")
        {
            strculture = "en";
        }
        else
        ...
        if (!this.IsPostBack)
        {
            //Modified by MF on 20150406, MES-070
        ...
        switch (e.Row.RowType)
        {
            case DataControlRowType.Header:
                ...
                for (int j = 0; j <= 5; j++)
                {
                    ...
                    tcHeader[j].Attributes.Add("bgcolor", "#507CD1");
                    tcHeader[j].Attributes.Add("align","left");
                }
            ...
            case DataControlRowType.DataRow:
                ...
                for (int j = 1; j < gvBody.Rows.Count; j++)
                {
                    ...
                    if (previousRow.Cells[1].Text == row.Cells[1].Text)
                    {
                        if (ddProcessCd.Text == "CUT")
                        {
                            if (previousRow.Cells[2].RowSpan == 1 && previousRow.Cells[3].RowSpan == 1 && previousRow.Cells[5].RowSpan == 1)
                            {
                        ...
                        {
                            if (previousRow.Cells[2].RowSpan == 1 && previousRow.Cells[3].RowSpan == 1 && previousRow.Cells[4].RowSpan == 1)
                            {
                                previousRow.Cells[2].RowSpan = 2;
                                previousRow.Cells[3].RowSpan = 2;
            ...
            case DataControlRowType.Footer:
                for (int i = 0; i < e.Row.Cells.Count; i++)
                {
                    e.Row.Cells[i].Attributes.Add("bgcolor", "#507CD1");
                    e.Row.Cells[i].Attributes.Add("align", "left");
