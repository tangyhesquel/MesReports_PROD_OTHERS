...
{
    /// <summary>
    ///AccruedExpenseReportSql 的摘要说明
    /// </summary>
    public class AccruedExpenseReportSql
    {
        public static DataTable GetAccruedExpense(string factory, string startDate, string endDate, string joNo, string contractNo)
        {
            string SQL = "";
