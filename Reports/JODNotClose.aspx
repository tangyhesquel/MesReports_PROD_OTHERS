<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JODNotClose.aspx.cs" Inherits="Reports_mesMarkerCSBreakdown" %>

<%@ Register Src="~/UserControls/ExportDataUserControl.ascx" TagPrefix="mes" TagName="ExportData" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>UpToDate Completed JO List For Process Close</title>
        ...
        <fieldset>
            ...
            <table width="100%" id="queryTab">
                <tr>
                    ...
                    <td class="style2" align="center" style="width: 12em">
                        <b>(洗水方式)WASH TYPE:</b>
                    </td>
                    <td>
        ...
        <table id="ExcTable" width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td align="center" style="font-size: large">
                    UpToDate Completed JO List For Process Close
                </td>
            </tr>
            <tr>
                <td>
