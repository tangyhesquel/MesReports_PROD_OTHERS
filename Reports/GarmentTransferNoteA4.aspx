<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GarmentTransferNoteA4.aspx.cs" 
Inherits="Reports_GarmentTransferNoteA4" %>
...
<body class="PaperWidth" style="padding: 1em; padding-top: 0px;">
    ...
    <div class="Noprint">
        ...
        <asp:CheckBox ID="summaryOnly" runat="server" Text="Summary Only" AutoPostBack="true" OnCheckedChanged="summaryOnly_checkChanged" Visible="true" Checked="true" />
