<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScanPackLeftoverReport.aspx.cs" Inherits="Reports_ScanPackLeftoverReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Scan Pack & Leftover Report</title>
    <style type="text/css">
        BODY
        {
            font-size: 12px;
    ...
    <script type="text/javascript">
        ...
        function toPaseExcel() {
            ...
            if (myExcel != null) {
                ...
                window.clipboardData.setData("Text", document.all.ExcelTable.outerHTML);
        ...
        function ToExcelOfWPS() {
            ...
            if (myExcel != null) {
                ...
                sel.moveToElementText(ExcelTable);
                sel.select();
...
<body onload="init()">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DDSummaryBy" runat="server">
                            <asp:ListItem Value="ByJO" Text="JO NO"></asp:ListItem>
                            <asp:ListItem Value="ByLOT" Text="JO BY LOT"></asp:ListItem>
                            <asp:ListItem Value="ByBPO" Text="JO BY BPO NO"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td width="20%">
                    ...
                    <td width="3%">
                        <input type="image" src="../Images/ok.png" ID="Approved" runat="server" OnServerClick="Approve_Click" />
                    </td>
                    <td width="3%">
                        <input type="image" src="../Images/cancel.png" ID="UnApproved" runat="server" OnServerClick="UnApprove_Click" />
                    </td>
                </tr>
            </table>
        </fieldset>
    ...
    <table id="ButtonTbale" width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td align="center">
                <font face="Arial" size="4">Scan Pack & Leftover Report</font>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <asp:Label ID="ApproveJOLabel" runat="server" Visible="False" Width="100%"></asp:Label>
        <asp:Label ID="ApproveScanPackLabel" runat="server" Visible="False" Width="100%"></asp:Label>
        <asp:Label ID="ApproveScanPackPerLabel" runat="server" Visible="False" Width="100%"></asp:Label>
        <tr>
            <td>
   ...
   <table id="ExcelTable" width="100%" border="0" cellpadding="0" cellspacing="0">
