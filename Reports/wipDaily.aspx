<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wipDaily.aspx.cs" Inherits="Reports_wipDaily" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function searchJo() {
            var urlName = "searchJO.aspx?factory=<%=FactoryCD %>>&userRandom=" + (Math.random() * 100000);
        ...
        <fieldset>
            ...
            <table width="100%" id="queryTab">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlproductFactory" runat="server">
                            <asp:ListItem></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td height="19" class="tdbackcolor">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlToGarmentType" runat="server" AutoPostBack="True">
                            <asp:ListItem Value=""></asp:ListItem>
                            <asp:ListItem Value="K">Knit</asp:ListItem>
                            <asp:ListItem Value="W">Woven</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td colspan="2">
                        <asp:DropDownList ID="ddlToproductFactory" runat="server">
                            <asp:ListItem></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="cbTRX_DATE" runat="server" Text="Transaction Date" />
                    </td>
                    <td>
                        <asp:CheckBox ID="cbBPO_DATE" runat="server" Text="BPO Date" />
                    </td>
                    <td height="19" class="tdbackcolor">
                        Summary By:
                    </td>
                    <td>
                        <asp:DropDownList ID="SummaryByDDL" runat="server" AutoPostBack="True">
                            <asp:ListItem >JO TTL</asp:ListItem>
            ...
            <tr>
                <td>
                    <div id="divBody" runat="server">
                        <asp:GridView ID="gvBody" runat="server" Width="100%" ShowHeader="true" ShowFooter="false"
                            OnRowDataBound="gvBody_RowDataBound">
                            <HeaderStyle BackColor="#EFEFE7" />
                        </asp:GridView>
                    </div>
                </td>
            </tr>
