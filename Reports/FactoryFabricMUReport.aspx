<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FactoryFabricMUReport.aspx.cs"
    ...
    <div>
        ...
        <div id="ExcTable">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td align="center" colspan="10">
                        <font face="Arial" size="4">Factory Fabric MU Report</font>
                    </td>
                </tr>
                <tr>
                    <td width="20%">
            ...
            <asp:GridView ID="gvDetail" runat="server" Width="2100px" OnRowDataBound="gvDetail_RowDataBound"
                AutoGenerateColumns="true" ShowHeader="true" ShowFooter="True">
