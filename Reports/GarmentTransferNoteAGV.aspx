<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GarmentTransferNoteAGV.aspx.cs" Inherits="Reports_GarmentTransferNoteAGV" %>
...
<body class="PaperWidth" style="padding: 1em; padding-top: 0px;">
    ...
    <br />
        ...
        <%--<img id="barcodeImage" src="<%=ResolveUrl("~/BarcodeHandler_AGV.ashx")%>?<%=lblDocNOText.Text %>" />--%>
      
    <table style="width:100%" >
      <tr>
       <td style="width:80%" valign="top">
        <table class="borderTalbe centerAlignTable" style="width:100%">
            <tr>
                <td class="style1">
    ...
    <div id="divYMGdetail" runat="server" style="clear: both;width:100%" visible="False">
        <br />
    ...
    <div id="body" runat="server" style="clear: both; width:97%">
      ...
      <td valign="top">
        <br />
        <img id="barcodeImage" src="<%=ResolveUrl("~/BarcodeHandler_AGV.ashx")%>?<%=lblDocNOText.Text %>" class="rotate" />
      </td>
     </tr>
    </table>
   </form>
